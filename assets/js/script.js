...
const ASCII_ART = [
  "                         __          __",
  "  ____ ____  _________  / /_  __  __/ /____  _____",
  " / __ `/ _ \/ ___/ __ \/ __ \/ / / / __/ _ \/ ___/",
  "/ /_/ /  __/ /  / /_/ / /_/ / /_/ / /_/  __(__  )",
  "\__,_/\___/_/   \____/_.___/\__, /\__/\___/____/",
  "                           /____/"
];
...
(function() {
    ...
    function reinitPage() {
        ...
        if (rotatingEl && cursorEl) {
            var roles = ['soc analyst', 'threat hunter', 'incident responder', 'purple teamer', 'threat intelligence analyst', 'ai red teamer'];
