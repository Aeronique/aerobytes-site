...
4. Closes the page after some timeout (I never measured exactly how long)
...
- All `on\w+=` attributes (onerror, onload, ontoggle, every variant I tried)
- `javascript:` URIs
...
5. I fetch the same URL unauthenticated, nginx serves the cached flag
